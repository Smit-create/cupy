...
class TestSpecial:
    ...
    def test_j0(self):
        self.check_unary('j0')
        self.test_scipy_backend('j0')

    def test_j1(self):
        self.check_unary('j1')
        self.test_scipy_backend('j1')

    def test_y0(self):
        self.check_unary('y0')
        self.test_scipy_backend('y0')

    def test_y1(self):
        self.check_unary('y1')
        self.test_scipy_backend('y1')

    def test_i0(self):
        self.check_unary('i0')
        self.test_scipy_backend('i0')

    def test_i1(self):
        self.check_unary('i1')
        self.test_scipy_backend('i1')
    ...
    def test_scipy_backend(self, name, xp):
